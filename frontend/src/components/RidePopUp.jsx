  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-between gap-2">
        ...
        {/* Confirm ride button */}
        <div className="flex items-center justify-between mt-5 w-[90%]">
        <button
            onClick={() => {
              props.setRidePopupPanel(false);
            }}
            className="p-3 px-8 font-semibold text-gray-900 bg-gray-300 rounded-lg"
          >
            Ignore
          </button>
          <button
            ...
            className="p-3 px-8 font-semibold text-white bg-green-600 rounded-lg"
          >
            Accept
          </button>
