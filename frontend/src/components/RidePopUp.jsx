    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-between gap-2">
        ...
        <button
          ...
          className="w-full p-2 font-semibold text-gray-900 bg-gray-300 rounded-lg"
        >
